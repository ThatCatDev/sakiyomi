-- Fix accept_team_invitation function to properly reference enum types
-- The function was using empty search_path which broke enum type resolution
...
begin
  ...
  where token = p_token
    and invitation_type = 'link'::public.invitation_type
